...
/**
 * @typedef {'Paper' | 'Concept' | 'Technology' | 'Dataset' | 'Author'} NodeType
 */

/**
 * @typedef {'CITES' | 'BUILDS_ON' | 'EXTENDS' | 'USES' | 'CONTRADICTS'} EdgeType
 */

/**
 * @typedef {'Source Verified' | 'Local Index' | 'Inferred Relation'} ProvenanceType
 */
 ...
 * @property {string} source - Primary publication venue or repository (e.g., 'arXiv', 'SSRN', 'IEEE', 'Vers3Dynamics')
 * @property {string} url - Direct verified URL to artifact or publication
 * @property {string[]} tags - Categorical tags (e.g., 'quantum', 'cymatics', 'neural')
