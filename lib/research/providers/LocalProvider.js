...
const { validateDocument } = require('../types');
...
class LocalProvider extends BaseProvider {
  ...
  /**
   * Loads and indexes an array of research documents.
   * @param {import('../types').ResearchDocument[]} docs
   */
  load(docs) {
    this.documents = [];
    this.docMap.clear();
   ...
   * Search documents.
   * @param {string} [query='']
   * @param {import('./BaseProvider').SearchFilters} [filters={}]
